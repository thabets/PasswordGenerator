...
function generatePassword() {
    let length = window.prompt("How long would you like your password to be? Please choose a number between 8 to 128 characters");
    var passwordLength = parseInt(length,10);
if (length > 128 || length < 8 || passwordLength === 'string'){
